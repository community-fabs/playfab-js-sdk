...
export interface DeleteEventSamplingRatioRequest extends IPlayFabRequestCommon {
  /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
  CustomTags?: Record<string, string | null>;
...
export interface DeleteEventSamplingRatioResult extends IPlayFabResultCommon {
}
...
export interface EventSamplingRatio {
  EventName?: string;
  EventNamespace?: string;
  Ratio: number;
}
...
export interface GetEventSamplingRatioRequest extends IPlayFabRequestCommon {
  /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
  CustomTags?: Record<string, string | null>;
  /** Name of the sampled event */
  EventName: string;
...
export interface GetEventSamplingRatioResult extends IPlayFabResultCommon {
  /** Name of the sampled event */
  EventName: string;
  /** Namespace of the sampled event */
  EventNamespace: string;
...
export interface GetEventSamplingRatiosRequest extends IPlayFabRequestCommon {
  /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
  CustomTags?: Record<string, string | null>;
}

export interface GetEventSamplingRatiosResult extends IPlayFabResultCommon {
...
export interface SetEventSamplingRatioRequest extends IPlayFabRequestCommon {
  /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
  CustomTags?: Record<string, string | null>;
  /** Name of the sampled event */
  EventName: string;
...
export interface SetEventSamplingRatioResult extends IPlayFabResultCommon {
}
